...
function rainbow_parenthsis#Activate()
	...
	highlight default level1c   ctermfg=brown        
	highlight default level2c   ctermfg=Darkblue     
	highlight default level3c   ctermfg=darkgray     
	highlight default level4c   ctermfg=darkgreen    
	highlight default level5c   ctermfg=darkcyan     
	highlight default level6c   ctermfg=darkred      
	highlight default level7c   ctermfg=darkmagenta  
	highlight default level8c   ctermfg=brown        
	highlight default level9c   ctermfg=gray         
	highlight default level10c  ctermfg=black        
	highlight default level11c  ctermfg=darkmagenta  
	highlight default level12c  ctermfg=Darkblue     
	highlight default level13c  ctermfg=darkgreen    
	highlight default level14c  ctermfg=darkcyan     
	highlight default level15c  ctermfg=darkred      
	highlight default level16c  ctermfg=red          
